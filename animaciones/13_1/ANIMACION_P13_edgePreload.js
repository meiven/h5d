/***********************
* Adobe Edge131 Preloader
*
* Do Not Edit this file
*
***********************/
window.AdobeEdge131 = window.AdobeEdge131 || {};
// Include yepnope
if(!AdobeEdge131.yepnope) {
...
AdobeEdge131.yepnope = window.yepnope;
}
// end yepnope
(function(compId){
...
AdobeEdge131._preloaders=AdobeEdge131._preloaders||[];AdobeEdge131._preloaders.push(function(){filesToLoad&&(loadResources(filesToLoad),filesToLoad=void 0)});function doLoadResources(){for(var a=0;a<AdobeEdge131._preloaders.length;a++)AdobeEdge131._preloaders[a]()}AdobeEdge131._readyplayers=AdobeEdge131._readyplayers||[];AdobeEdge131._readyplayers.push(function(){readyToPlay&&AdobeEdge131.okToLaunchComposition(compId)});
function playWhenReady(){AdobeEdge131._playWhenReady=!0;for(var a=0;a<AdobeEdge131._readyplayers.length;a++)AdobeEdge131._readyplayers[a]()}function edgeCallback(a){htFallbacks[a]&&(a=htFallbacks[a]);AdobeEdge131.preload.got[a]=!0;if(a==AdobeEdge131.preload.last)!AdobeEdge131.bootstrapLoading||AdobeEdge131._playWhenReady?AdobeEdge131.okToLaunchComposition(compId):readyToPlay=!0,AdobeEdge131.preload.busy=!1,AdobeEdge131.preload.q.length>0&&(a=AdobeEdge131.preload.q.pop(),AdobeEdge131.requestResources(a.files,a.callback))}
AdobeEdge131.requestResources=AdobeEdge131.requestResources||function(a,d){AdobeEdge131.yepnope.errorTimeout=4E3;AdobeEdge131.preload.busy=!0;AdobeEdge131.preload.got=AdobeEdge131.preload.got||{};var e,b=a.length,h=[],c;for(e=0;e<b;e++){c=a[e];if(typeof c==="string")url=c,c={load:url};else if(url=c.yep||c.load,c.callback){var k=c.callback;c.callback=function(a,b,c){k(a,b,c)&&d(a,b,c)}}if(!c.callback)c.callback=d;if(!AdobeEdge131.preload.got[url])h.push(c),AdobeEdge131.preload.last=url}h.length&&AdobeEdge131.yepnope(h)};
var filesToLoad,dlContent,preContent,doDelayLoad,signaledLoading,loadingEvt,requiresSVG,htLookup={},aLoader,aEffectors;function loadResources(a,d){AdobeEdge131.preload=AdobeEdge131.preload||[];AdobeEdge131.preload.q=AdobeEdge131.preload.q||[];d||!isCapable()?filesToLoad=a:AdobeEdge131.preload.busy?AdobeEdge131.preload.q.push({files:a,callback:edgeCallback}):AdobeEdge131.requestResources(a,edgeCallback)}
...
var fnCycle=function(a){a?fnCycle&&setTimeout(fnCycle,20):a={event:"loading",progress:0};loadingEvt&&loadingEvt(a)},aBootcompsLoaded=[];if(!window.AdobeEdge131.bootstrapListeners)window.AdobeEdge131.bootstrapListeners=[];window.AdobeEdge131.bootstrapCallback=function(a){window.AdobeEdge131.bootstrapListeners.push(a);if(aBootcompsLoaded.length>0)for(var d=0;d<aBootcompsLoaded.length;d++)a(aBootcompsLoaded[d])};if(!window.AdobeEdge131.preloadComplete)window.AdobeEdge131.preloadComplete={};
window.AdobeEdge131.preloadComplete[compId]=function(a){AdobeEdge131.$_(".edgePreload"+a).css("display","none");fnCycle=null;loadingEvt&&loadingEvt({event:"done",progress:1,reason:"complete"});aBootcompsLoaded.push(a);for(var d=window.AdobeEdge131.bootstrapListeners.length,e=0;e<d;e++)try{window.AdobeEdge131.bootstrapListeners[e](a)}catch(b){console.log("bootstrap error "+b)}};function isCapable(){if(hasTransform){if(requiresSVG&&!hasSVG)return!1;return!0}return!1}
function onDocLoaded(){window.AdobeEdge131.loaded=!0;fnCycle({event:"begin"});isCapable()?(preContent&&preContent.dom&&simpleContent(preContent.dom,"edgePreload"+compId),filesToLoad&&!signaledLoading&&(loadResources(filesToLoad),filesToLoad=void 0)):dlContent&&dlContent.dom&&(loadingEvt&&loadingEvt({event:"done",progress:1,reason:"downlevel"}),simpleContent(dlContent.dom))};
window.AdobeEdge131 = window.AdobeEdge131 || {};
window.AdobeEdge131.framework = 'jquery';
if(document.addEventListener ){ 
   ...
   aLoader = [
    { load: "animaciones/13_1/edge_includes/jquery-1.7.1.min.js"},
    { load: "animaciones/13_1/edge_includes/edge.1.5.0.min.js"},
          { load: "animaciones/13_1/ANIMACION_P13_edge.js"},
          { load: "animaciones/13_1/ANIMACION_P13_edgeActions.js"}];

if (AdobeEdge131.bootstrapLoading) { signaledLoading = true; AdobeEdge131.loadResources=doLoadResources; AdobeEdge131.playWhenReady=playWhenReady; }
